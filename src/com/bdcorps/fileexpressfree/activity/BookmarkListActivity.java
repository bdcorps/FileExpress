...
import com.bdcorps.fileexpressfree.adapters.BookmarkListAdapter;
import com.bdcorps.fileexpressfree.model.FileListEntry;
import com.bdcorps.fileexpressfree.util.PreferenceHelper;
import com.bdcorps.fileexpressfree.workers.BookmarkLoader;
...
public class BookmarkListActivity extends BaseFileListActivity {
		...
		bookmarkListView
				.setOnItemLongClickListener(new OnItemLongClickListener() {
					...
					public boolean onItemLongClick(AdapterView<?> arg0,
						...
						if (!isPicker) {
							FileListEntry bookmark = (FileListEntry) bookmarkListView
	...
	protected void removeBookmark(final FileListEntry bookmark) {
		...
		builder.setMessage(
				getString(R.string.confirm_remove_bookmark, bookmark.getName()))
				.setCancelable(false)
				.setPositiveButton(android.R.string.ok,
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int id) {

								bookmarker.removeBookmark(bookmark.getPath()
										.getAbsolutePath());
							}
						})
	...
	protected void select(File path) {
		...
		intent.putExtra(FileExplorerApp.EXTRA_SELECTED_BOOKMARK,
				...
				.setPositiveButton(android.R.string.ok,
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
								...
								try {
									File toDir = new File(bookmarkPath
											.toString());
									if (toDir.isDirectory() && toDir.exists()) {
										bookmarker.addBookmark(bookmarkPath
												.toString());
									} else {
									...
									Log.e(TAG, "Error bookmarking path"
											+ bookmarkPath, e);
									new Builder(BookmarkListActivity.this)
											.setTitle(getString(R.string.error))
											.setMessage(
													getString(R.string.path_not_exist))
											.show();
								}
							}
						})
