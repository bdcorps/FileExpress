...
import com.bdcorps.fileexpressfree.activity.BaseFileListActivity;
import com.bdcorps.fileexpressfree.activity.FileListActivity;
import com.bdcorps.fileexpressfree.model.FileListEntry;
import com.bdcorps.fileexpressfree.util.PreferenceHelper.SortField;
	...
	public int compare(FileListEntry file1, FileListEntry file2) {
		...
		if (dirsOnTop) {
			if (file1.getPath().isDirectory() && file2.getPath().isFile()) {
				return -1;
			} else if (file2.getPath().isDirectory()
					&& file1.getPath().isFile()) {
				return 1;
			}
		}
		...
		case MTIME:
			return dir
					* file1.getLastModified()
							.compareTo(file2.getLastModified());

		case SIZE:
			return dir
					* Long.valueOf(file1.getSize()).compareTo(file2.getSize());
