...
import com.bdcorps.fileexpressfree.exception.LocationInvalidException;
...
public final class PreferenceHelper {
	...
	public int getTheme() {
		 ...
		 * .getString(PREF_THEME, VALUE_THEME_WHITE); if
		 * (VALUE_THEME_BLACK.equalsIgnoreCase(theme)) { return
		 * FileExplorerApp.THEME_BLACK; } else if
		 * (VALUE_THEME_WHITE_BLACK.equalsIgnoreCase(theme)) { return
		 * FileExplorerApp.THEME_WHITE_BLACK; } else { return
		 * FileExplorerApp.THEME_WHITE; }
		 */
	}
}
